    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                ...
                <form action="${hContext}/login/login.do" class="form-horizontal"
                    name="login_form" method="get">
                    <!-- div 언어 -->
                    <div class="form-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <select class="form-control" name="lang" id="lang">
                                <option value="en"><spring:message
                                        code='message.user.login.language.en' /></option>
                                <option value="ko"><spring:message
                                        code='message.user.login.language.ko' /></option>
                            </select>
                        </div>
                    </div>
